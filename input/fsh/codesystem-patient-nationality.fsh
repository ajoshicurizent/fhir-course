// This is a FSH file creating Lean Core Nationality CodeSystem to manage the codes defined by SHDD
// SUSHI will look for definitions in any file using the .fsh ending.
CodeSystem: ISO3166Part1Alpha3
...
* ^meta.source = "urn:iso:std:iso:3166"
* ^url = "urn:iso:std:iso:3166"
* insert CommonMetadataRuleSet
* ^caseSensitive = true
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:iso:std:iso:3166"
* #AFG "Afghanistan"
* #ALA "Åland Islands"
* #ALB "Albania"
* #DZA "Algeria"
